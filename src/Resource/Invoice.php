...
use Ameax\SevDeskApi\Requests\Invoice\BookInvoice;
use Ameax\SevDeskApi\Requests\Invoice\CancelInvoice;
use Ameax\SevDeskApi\Requests\Invoice\CreateInvoiceByFactory;
use Ameax\SevDeskApi\Requests\Invoice\CreateInvoiceFromOrder;
use Ameax\SevDeskApi\Requests\Invoice\CreateInvoiceReminder;
use Ameax\SevDeskApi\Requests\Invoice\GetInvoiceById;
use Ameax\SevDeskApi\Requests\Invoice\GetInvoicePositionsById;
use Ameax\SevDeskApi\Requests\Invoice\GetInvoices;
use Ameax\SevDeskApi\Requests\Invoice\GetIsInvoicePartiallyPaid;
use Ameax\SevDeskApi\Requests\Invoice\InvoiceEnshrine;
use Ameax\SevDeskApi\Requests\Invoice\InvoiceGetPdf;
use Ameax\SevDeskApi\Requests\Invoice\InvoiceGetXml;
use Ameax\SevDeskApi\Requests\Invoice\InvoiceRender;
use Ameax\SevDeskApi\Requests\Invoice\InvoiceResetToDraft;
use Ameax\SevDeskApi\Requests\Invoice\InvoiceResetToOpen;
...
class Invoice extends Resource
{
	 ...
	 */
	public function invoiceGetXml(int $invoiceId): Response
	{
		return $this->connector->send(new InvoiceGetXml($invoiceId));
	}
