...
use Ameax\SevDeskApi\Resource\AccountingContact;
use Ameax\SevDeskApi\Resource\Basics;
use Ameax\SevDeskApi\Resource\CheckAccount;
use Ameax\SevDeskApi\Resource\CheckAccountTransaction;
use Ameax\SevDeskApi\Resource\CommunicationWay;
use Ameax\SevDeskApi\Resource\Contact;
use Ameax\SevDeskApi\Resource\ContactAddress;
use Ameax\SevDeskApi\Resource\ContactField;
use Ameax\SevDeskApi\Resource\CreditNote;
use Ameax\SevDeskApi\Resource\CreditNotePos;
use Ameax\SevDeskApi\Resource\Export;
use Ameax\SevDeskApi\Resource\Invoice;
use Ameax\SevDeskApi\Resource\InvoicePos;
use Ameax\SevDeskApi\Resource\Layout;
use Ameax\SevDeskApi\Resource\Order;
use Ameax\SevDeskApi\Resource\OrderPos;
use Ameax\SevDeskApi\Resource\Part;
use Ameax\SevDeskApi\Resource\Report;
 ...
 */
class SevDesk extends Connector
{
	use AcceptsJson;
